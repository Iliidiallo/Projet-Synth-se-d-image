...
void constructionDragon();//fonction pour construire un dragon
...
//cone pour le cou du dragon
     glPushMatrix();
       ...
       glDisable(GL_TEXTURE_2D);//desactiver la texture sur cette partie
...
/*****************corps du dragon****************************/
     ...
     glPushMatrix();
     glActiveTextureARB(GL_TEXTURE0_ARB);
     glEnable(GL_TEXTURE_2D);//active la texture pour la sphere sur le ventre
       glColor3f(1.0,1.0,1.0);
       glTranslatef(0,0,0);
       remplirPoint(3);
     glPopMatrix();
...
//creation du Cube
     ...
     glPushMatrix();
     glActiveTextureARB(GL_TEXTURE0_ARB);
     glEnable(GL_TEXTURE_2D);//on active la texture sur le cube
       glColor3f(1.0,1.0,1.0);
...
/***********************************ecail dragon*********************************************/
//sur le dos de notre dragon on a mis des cylindres pour representer les ecails .
     glPushMatrix();
       glColor3f(0.83,0.31,0.20);
...
/************************Conception de l'Aile*****************************/
   ...
   /************ ailes Gauche *****************/
     ...
     glPushMatrix();
        ...
        glPushMatrix();
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glEnable(GL_TEXTURE_2D); //on active les textures sur le cube .
           glColor3f(1,1,1);
        ...
        glPushMatrix();
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glDisable(GL_TEXTURE_2D); //on desactive les textures sur le cone sinon la couleur de la texture influence notre figure qui n'est pas parametrique .
           glColor3f(0.41,0.14,0.10);
...
/***************ailes Droite*******************************/
     glPushMatrix();
           ...
           glRotatef(60,-10,0,0);
           glActiveTextureARB(GL_TEXTURE0_ARB);
           glEnable(GL_TEXTURE_2D);//on active la textures sur cette partie du dragon .
           //1er etage
        glPushMatrix();
           glColor3f(1,1,1);
           glTranslatef(-2.0,3.3,-1.1);
        ...
        glPushMatrix();
           glActiveTextureARB(GL_TEXTURE0_ARB);
           glEnable(GL_TEXTURE_2D);//on active la textures sur le cube .
           glColor3f(1,1,1);
           glTranslatef(-1,6.3,-1.1);
           glScalef(6,3,0.1);
           dessinCube();
        ...
        glPushMatrix();
           glActiveTextureARB(GL_TEXTURE0_ARB);
           glDisable(GL_TEXTURE_2D);//on desactive les textures sur le cube .
           glColor3f(0.41,0.14,0.10);
           glTranslatef(5.7,9.3,-1.1);
           glScalef(2,1,0.07);
           glutSolidCone(1.7,1.5,3,4);
...
/**********************Main Droite****************************/
        ...
        glPushMatrix();
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glDisable(GL_TEXTURE_2D);//on desactive la texture sur les gluts .
            glColor3f(0.83,0.31,0.20);
            glTranslatef(-5.5,-2.8,-1.7);
            glRotatef(90,1,-1,0.0);
            glutSolidCylinder(0.5,2,8,8);
...
/**********************pieds Gauche****************************/
    ...
    //creation du bras du pieds gauche haut
        ...
        glPushMatrix();
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glDisable(GL_TEXTURE_2D);//on desactive la textures sur le cylindre pour ne pas qu'elle influence la couleur du cylindre.
            glColor3f(0.41,0.14,0.10);
    ...
    //sphere articulation pied gauche
        glPushMatrix();
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glEnable(GL_TEXTURE_2D);//on active la texture sur la sphere d'articulation
            glColor3f(1.0,1.0,1.0);
    ...
    //cylindre bas de pieds gauche
        ...
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glDisable(GL_TEXTURE_2D);
            glColor3f(0.83,0.31,0.20);//on desactive la textures sur le cylindre pour ne pas qu'elle influence la couleur du cylindre.
...
/********************Pied_droit*****************************/
    ...
    //sphere articulation pied droit
        glPushMatrix();
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glEnable(GL_TEXTURE_2D);//on active la texture sur la sphere
            glColor3f(1.0,1.0,1.0);
            glTranslatef(0,-4.7,-1.1);
            glRotatef(90,1,0,0.0);
            remplirPoint(0.5);
...
/*********************************QUEUE***************************/
   glPushMatrix();
        ...
        glPushMatrix();
        glActiveTextureARB(GL_TEXTURE0_ARB);
        glEnable(GL_TEXTURE_2D);//on active la texture sur la sphere de la queue
            glColor3f(1.0,1.0,1.0);
